...
export default function GpusAdmin() {
  const mockData = [
    { id: '1', name: 'RTX 3060 Ti', brand: 'NVIDIA', price: 350000, vram: '8GB', chipset: 'RTX 3060 Ti', power: '200W' },
    { id: '2', name: 'RX 6800 XT', brand: 'AMD', price: 450000, vram: '16GB', chipset: 'RX 6800 XT', power: '300W' },
  ];  
          ...
          <div className="flex flex-col gap-5 text-sm font-medium text-blancoHueso">
            ...
            <div>
              ...
              <Select size="small" fullWidth className="bg-[#0D0D0D] text-white rounded">
                ...
                <MenuItem value="RTX 3060 Ti">RTX 3060 Ti</MenuItem>
                <MenuItem value="RTX 4070">RTX 4070</MenuItem>
                <MenuItem value="RX 6600 XT">RX 6600 XT</MenuItem>
                <MenuItem value="RX 6800 XT">RX 6800 XT</MenuItem>
              </Select>
            </div>

            {/* Consumo */}
            <div>
              <label className="block mb-1 text-textoSecundario">Consumo (W):</label>
            ...
            >
              <TableHead>
                <TableRow className="bg-[#7F00FF]">
                  {['name', 'brand', 'vram', 'chipset', 'power', 'price'].map((field) => (
                    <TableCell
                      key={field}
              ...
              <TableBody>
                {filteredData.map((item) => (
                  ...
                  >
                    ...
                    <TableCell className="font-medium">{item.vram}</TableCell>
                    <TableCell className="font-medium">{item.chipset}</TableCell>
                    <TableCell className="font-medium">{item.power}</TableCell>
        ...
        <div className="fixed inset-0 flex items-center justify-center modal-fondo z-50">
          <div className="bg-[#1A1A1A] rounded-xl p-6 w-full max-w-md shadow-xl border border-[#7F00FF] relative text-white">
            ...
            <form className="flex flex-col gap-4">
              ...
              {/* Chipset */}
              <Select size="small" displayEmpty defaultValue="" sx={selectEstilos}>
                <MenuItem value="">Chipset</MenuItem>
                <MenuItem value="RTX 3060 Ti">RTX 3060 Ti</MenuItem>
                <MenuItem value="RTX 4070">RTX 4070</MenuItem>
                <MenuItem value="RX 6600 XT">RX 6600 XT</MenuItem>
                <MenuItem value="RX 6800 XT">RX 6800 XT</MenuItem>
