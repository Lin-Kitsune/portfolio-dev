...
export default function MotherboardsAdmin() {
  const mockData = [
    { id: '1', name: 'B450M DS3H', brand: 'Gigabyte', price: 65000, socket: 'AM4', chipset: 'B450', formFactor: 'Micro-ATX' },
    { id: '2', name: 'Z690 Aorus Elite', brand: 'Gigabyte', price: 220000, socket: 'LGA1700', chipset: 'Z690', formFactor: 'ATX' },
  ];    
            ...
            >
              <TableHead>
                <TableRow className="bg-[#7F00FF]">
                  {['name', 'brand', 'socket', 'chipset', 'formFactor', 'price'].map((field) => (
                    <TableCell
                      key={field}
              ...
              <TableBody>
                {filteredData.map((item) => (
                  ...
                  >
                    ...
                    <TableCell className="font-medium">{item.formFactor}</TableCell>
