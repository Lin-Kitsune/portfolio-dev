...
export default function RamsAdmin() {
  const mockData = [
    { id: '1', name: 'Corsair Vengeance LPX', brand: 'Corsair', price: 42000, capacity: '16GB', speed: '3200MHz', type: 'DDR4' },
    { id: '2', name: 'Kingston Fury Beast', brand: 'Kingston', price: 56000, capacity: '32GB', speed: '3600MHz', type: 'DDR4' },
  ];  
        ...
        <div className="w-64 bg-[#1A1A1A] p-5 rounded-xl shadow-lg border border-[#7F00FF] text-white">
          ...
          <div className="flex flex-col gap-5 text-sm font-medium text-blancoHueso">
            ...
            <div>
              ...
              <Select size="small" fullWidth className="bg-[#0D0D0D] text-white rounded">
                <MenuItem value="">Todas</MenuItem>
                <MenuItem value="2666MHz">2666MHz</MenuItem>
                <MenuItem value="3200MHz">3200MHz</MenuItem>
                <MenuItem value="3600MHz">3600MHz</MenuItem>
                <MenuItem value="4000MHz">4000MHz</MenuItem>
              </Select>
            </div>
            ...
            >
              <TableHead>
                <TableRow className="bg-[#7F00FF]">
                  {['name', 'brand', 'capacity', 'speed', 'type', 'price'].map((field) => (
                    <TableCell
                      key={field}
        ...
        <div className="fixed inset-0 flex items-center justify-center modal-fondo z-50">
          ...
          <h3 className="text-xl font-bold mb-4 text-acento">Agregar nueva RAM</h3>
            ...
            <form className="flex flex-col gap-4">
              ...
              {/* Velocidad */}
              <Select size="small" displayEmpty defaultValue="" sx={selectEstilos}>
                <MenuItem value="">Velocidad</MenuItem>
                <MenuItem value="2666MHz">2666MHz</MenuItem>
                <MenuItem value="3200MHz">3200MHz</MenuItem>
                <MenuItem value="3600MHz">3600MHz</MenuItem>
                <MenuItem value="4000MHz">4000MHz</MenuItem>
