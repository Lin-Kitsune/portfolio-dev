...
export default function PsusAdmin() {
  const mockData = [
    { id: '1', name: 'Corsair RM750x', brand: 'Corsair', price: 95000, wattage: 750, certification: '80 Plus Gold', modular: 'Sí' },
    { id: '2', name: 'EVGA 600 BR', brand: 'EVGA', price: 55000, wattage: 600, certification: '80 Plus Bronze', modular: 'No' },
  ];  
      ...
      <div className="flex gap-6">
        ...
        <div className="w-64 bg-[#1A1A1A] p-5 rounded-xl shadow-lg border border-[#7F00FF] text-white">
          ...
          <div className="flex flex-col gap-5 text-sm font-medium text-blancoHueso">
            ...
            {/* Potencia (Wattage) */}
            <div>
              <label className="block mb-1 text-textoSecundario">Potencia:</label>
              <Select size="small" fullWidth className="bg-[#0D0D0D] text-white rounded">
                <MenuItem value="">Todas</MenuItem>
            ...
            <div>
              ...
              <Select size="small" fullWidth className="bg-[#0D0D0D] text-white rounded">
                <MenuItem value="">Todas</MenuItem>
                <MenuItem value="80 Plus Bronze">80 Plus Bronze</MenuItem>
                <MenuItem value="80 Plus Gold">80 Plus Gold</MenuItem>
                <MenuItem value="80 Plus Platinum">80 Plus Platinum</MenuItem>
              </Select>
            </div>
            ...
            >
              <TableHead>
                <TableRow className="bg-[#7F00FF]">
                  {['name', 'brand', 'wattage', 'certification', 'modular', 'price'].map((field) => (
                    <TableCell
                      key={field}
                    ...
                    >
                      {field === 'name' && 'Nombre'}
                      {field === 'brand' && 'Marca'}
                      {field === 'wattage' && 'Potencia'}
                      {field === 'certification' && 'Certificación'}
                      {field === 'modular' && 'Modular'}
                      {field === 'price' && 'Precio'}
              ...
              <TableBody>
                {filteredData.map((item) => (
                  ...
                  >
                    ...
                    <TableCell className="font-medium">{item.wattage}</TableCell>
                    <TableCell className="font-medium">{item.certification}</TableCell>
                    <TableCell className="font-medium">{item.modular}</TableCell>
          ...
          <h3 className="text-xl font-bold mb-4 text-acento">Agregar nueva fuente de poder</h3>
            ...
            <form className="flex flex-col gap-4">
              ...
              <Select size="small" displayEmpty defaultValue="" sx={selectEstilos}>
                <MenuItem value="">Potencia (W)</MenuItem>
                <MenuItem value="500">500W</MenuItem>
                <MenuItem value="600">600W</MenuItem>
                <MenuItem value="750">750W</MenuItem>
                <MenuItem value="850">850W</MenuItem>
