...
export default function DisksAdmin() {
  const mockData = [
    { id: '1', name: 'SSD Samsung 870 EVO', brand: 'Samsung', price: 45000, type: 'SSD', capacity: '1TB', interface: 'SATA' },
    { id: '2', name: 'WD Black SN850', brand: 'Western Digital', price: 98000, type: 'NVMe', capacity: '1TB', interface: 'PCIe Gen4' },
  ]; 
          ...
          <div className="flex flex-col gap-5 text-sm font-medium text-blancoHueso">
            ...
            <div>
              ...
              <Select size="small" value={filterType} onChange={(e) => setFilterType(e.target.value)}
                fullWidth className="bg-[#0D0D0D] text-white rounded">
          ...
          <div className="bg-[#1A1A1A] rounded-xl p-6 w-full max-w-md shadow-xl border border-[#7F00FF] relative text-white">
            ...
            <form className="flex flex-col gap-4">
              ...
              <Select size="small" displayEmpty defaultValue="" sx={selectEstilos}>
                <MenuItem value="">Tipo de disco</MenuItem>
                <MenuItem value="HDD">HDD</MenuItem>
                <MenuItem value="SSD">SSD</MenuItem>
                <MenuItem value="NVMe">M.2 NVMe</MenuItem>
              </Select>
