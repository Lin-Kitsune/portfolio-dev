...
export default function FansAdmin() {
  const mockData = [
    { id: '1', name: 'Ventilador RGB 120mm', brand: 'CoolerMaster', price: 12000, size: '120mm', rpm: '1500', rgb: 'sí' },
    { id: '2', name: 'Fan Silencioso 140mm', brand: 'Noctua', price: 18000, size: '140mm', rpm: '1200', rgb: 'no' },
  ];  
            ...
            >
              <TableHead>
                <TableRow className="bg-[#7F00FF]">
                  {['name', 'brand', 'size', 'rpm', 'rgb', 'price'].map((field) => (
                    <TableCell
                      key={field}
